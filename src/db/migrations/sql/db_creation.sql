...
create table "JavniPoziv" (
    ...
    "nazivPoziva" varchar(100),
    "datumi" dates,
    "procenjenaVrednost" price_type,
--     denormalizacija 3nf
    "oznakaValute" varchar(5),
    "oznakaId" integer constraint "JavniPoziv_Oznaka_fk" references "Oznaka",
    "valutaId" integer constraint "JavniPoziv_Valuta_fk" references "Valuta",
    "zaposleniId" integer constraint "JavniPoziv_Zaposleni_fk" references "Zaposleni"
);
...
create table "JavniPozivDetalji" (
    ...
    "opis" text,
    "dodatniPodaci" text,
    "dozvoljeneVarijante" bool,
    "adresaDostavljanja" varchar(50),
    "podlozanProduzenju" bool,
    "obrazlozenjeProduzenja" text,
    "osnovnaDelatnost" varchar(100)
);
...
returns trigger as $$
    begin
--         new."referentniBrojJP" := nextval('"JavniPoziv_referentniBrojJP_seq"') + 1;
--         select last_value + 1 from "JavniPoziv_referentniBrojJP_seq" into new."referentniBrojJP";
        begin
            select currval('"JavniPoziv_referentniBrojJP_seq"') + 1 into new."referentniBrojJP";
            exception
                when others then
                    new."referentniBrojJP" := 1;
        end;
--         if new."referentniBrojJP" = 1 then
--         new."referentniBrojJP" := nextval('"JavniPoziv_referentniBrojJP_seq"') + 1;
--         end if;
